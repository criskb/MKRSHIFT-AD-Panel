...
export function syncUIFromSettings(ui, settings){
  ...
  ui.bloomStrength.value = settings.bloomStrength;
  ui.bloomStrengthVal.textContent = String(settings.bloomStrength);
  ui.trailDamp.value = settings.trailDamp;
  ui.trailDampVal.textContent = String(settings.trailDamp);
  ui.vignette.value = settings.vignette;
  ui.vignetteVal.textContent = String(settings.vignette);
  ui.grain.value = settings.grain;
  ui.grainVal.textContent = String(settings.grain);
  ui.sharpen.value = settings.sharpen;
  ui.sharpenVal.textContent = String(settings.sharpen);
  ui.chromSplit.value = settings.chromSplit;
  ui.chromSplitVal.textContent = String(settings.chromSplit);
  ui.transitionSoftness.value = settings.transitionSoftness;
  ui.transitionSoftnessVal.textContent = String(settings.transitionSoftness);
